...
##take product id  as object id from products table and url from sellerproducts table only for seller
  ...
  Scenario Outline: Login with valid registered user details as a seller and  without follow field validation user wants to delete the image of product
    ...
    Then user should not be able to delete the image of product and user should get a validation message
      ...
      |  Invalid data provided    |
    Examples:
      | productId                     | seller                        | url        |
      |                               |  5e29912fbfec74a0272e9a92     | https://res.cloudinary.com/marketcube/image/upload/v1583155055/mc/test/product/5e537878edb8830017e45195/hxzuojwbbj1kurmrlhwj.jpg    |
      | 12345678901234567890          |  5e29912fbfec74a0272e9a92     | https://res.cloudinary.com/marketcube/image/upload/v1583155055/mc/test/product/5e537878edb8830017e45195/hxzuojwbbj1kurmrlhwj.jpg    |
      | 5e537878edb8830017e45195      | 5e29912fbfec74a0272e9a92      |             |
      | 5e537878edb8830017e45195      |  5e29912fbfec74a0272e9a92     | https://res.cloudinary.com/marketcube/image/upload/v1583155055/mc/test/product/5e537878edb8830017e45195/hxzuojwbbj1kurmrlhwj.jpg    |
      ...
      | 5e537878edb8830017e45195      | 12345678901234567890          | https://res.cloudinary.com/marketcube/image/upload/v1583155055/mc/test/product/5e537878edb8830017e45195/hxzuojwbbj1kurmrlhwj.jpg    |
