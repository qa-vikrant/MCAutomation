package net.mc.tools.models.updateProductBySellerAndVendor.updateProductRequest;
...
public class UpdateProductRequestModel
{
    ...
    public String getIsWebhook ()
    {
        return isWebhook;
    }

    public void setIsWebhook (String isWebhook)
    {
