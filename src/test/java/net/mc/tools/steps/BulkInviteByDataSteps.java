...
import net.mc.tools.services.BulkInviteByDataService;
...
public class BulkInviteByDataSteps {
    ...
    public void inviteShouldBeSent()
    {
        ...
        responseCommonForAllBooleanData = gson().fromJson(json_Response.body().prettyPrint(), ResponseCommonForAllBooleanData.class);
        Assert.assertEquals("ok" , responseCommonForAllBooleanData.getStatus());
        Assert.assertTrue(responseCommonForAllBooleanData.getData()==true);
    }
