...
import net.mc.tools.services.RegisterSelfSellerService;
...
public class RegisterSelfSellerSteps
{
    ...
    private RegisterSupplierBySelfResponseModel registerResponseModel;
    ...
    public void userShouldBeRegisteredSuccessfullyIntoTheSystem_for_seller()
    {
        ...
        registerResponseModel = gson().fromJson(json_Response.body().prettyPrint(), RegisterSupplierBySelfResponseModel.class);
