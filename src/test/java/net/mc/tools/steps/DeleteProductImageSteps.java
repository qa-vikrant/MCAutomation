...
import net.mc.tools.services.DeleteProductImageServices;
...
public class DeleteProductImageSteps
{
    ...
    private static DeleteProductImageRequest deleteProductImageRequest;
    ...
    {
     this.deleteProductImageRequest=deleteProductImageRequestList.get(0);
    }
    ...
    {
        jsonResponse= DeleteProductImageServices.deleteProductImageRequest(deleteProductImageRequest,LoginSteps.token);
        deleteProductImageRequest=null;
    ...
    {
        jsonResponse= DeleteProductImageServices.deleteProductImageRequest(deleteProductImageRequest,tokenMessageRequestModelList.get(0).gettoken());
        deleteProductImageRequest=null;
