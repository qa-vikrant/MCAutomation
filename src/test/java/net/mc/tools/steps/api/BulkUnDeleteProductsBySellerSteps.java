...
import net.mc.tools.services.auth.BulkUnDeleteProductsBySellerService;
...
public class BulkUnDeleteProductsBySellerSteps
{
    ...
    @Given("^user enters productIds to Un-Delete products$")
    public void user_enters_productIds_to_Un_Delete_products(List<String> productIdList) throws Exception
    {
    ...
    @Given("^user enter actions details to Un-Delete products$")
    public void user_enter_actions_details_to_Un_Delete_products(List<BulkProductRequestModel> bulkProductRequestModelList) throws Exception
    {
    ...
    public void user_make_request_to_Un_Delete_products_in_bulk() throws Exception
    {
        jsonResponse= BulkUnDeleteProductsBySellerService.BulkUnDeleteProductRequest(bulkProductRequestModel,LoginSteps.token);
    ...
    public void user_make_request_to_Un_Delete_products_in_bulk_with_invalid_Token(List<TokenMessageRequestModel> tokenMessageRequestModelList) throws Exception
    {
        jsonResponse= BulkUnDeleteProductsBySellerService.BulkUnDeleteProductRequest(bulkProductRequestModel,tokenMessageRequestModelList.get(0).gettoken());

    }

    @Then("^user should be able to Un-Delete products in bulk$")
    public void user_should_be_able_to_Un_Delete_products_in_bulk() throws Exception
    {
    ...
    public void user_should_not_be_able_to_Un_Delete_products_in_bulk(List<String> errorMessage) throws Exception
    {
