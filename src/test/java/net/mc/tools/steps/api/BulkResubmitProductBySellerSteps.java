...
import net.mc.tools.services.auth.BulkResubmitProductBySellerService;
...
public class BulkResubmitProductBySellerSteps
{
    ...
    @Given("^user enters productIds to Re-submit products$")
    public void user_enters_productIds_to_Re_submit_products(List<String> productIdList) throws Exception
    {
    ...
    @Given("^user enter actions details to Re-submit products$")
    public void user_enter_actions_details_to_Re_submit_products(List<BulkProductRequestModel> bulkProductRequestModelList) throws Exception
    {
    ...
    public void user_make_request_to_Re_submit_products_in_bulk() throws Exception
    {
        jsonResponse= BulkResubmitProductBySellerService.BulkResubmitProductRequest(bulkProductRequestModel,LoginSteps.token);
    ...
    public void user_make_request_to_Re_submit_products_in_bulk_with_invalid_Token(List<TokenMessageRequestModel> tokenMessageRequestModelList) throws Exception
    {
        jsonResponse= BulkResubmitProductBySellerService.BulkResubmitProductRequest(bulkProductRequestModel,tokenMessageRequestModelList.get(0).gettoken());

    }

    @Then("^user should be able to Re-submit products in bulk$")
    public void user_should_be_able_to_Re_submit_products_in_bulk() throws Exception
    {
    ...
    public void user_should_not_be_able_to_Re_submit_products_in_bulk(List<String> errorMessage) throws Exception
    {
