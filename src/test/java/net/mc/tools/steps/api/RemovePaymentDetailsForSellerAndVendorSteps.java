...
public class RemovePaymentDetailsForSellerAndVendorSteps
{
    ...
    private static ResponseCommonForAllBooleanData responseCommonForAllBooleanData;
    ...
    public void user_should_be_able_to_remove_payment_method_successfully_that_he_requested() throws Exception
    {
        ...
        responseCommonForAllBooleanData =gson().fromJson(response.body().prettyPrint(), ResponseCommonForAllBooleanData.class);
