...
import net.mc.tools.services.auth.BulkUnRejectProductsBySellerService;
...
public class BulkUnRejectProductsBySellerSteps
{
    ...
    @Given("^user enters productIds to Un-Reject products$")
    public void user_enters_productIds_to_Un_Reject_products(List<String> productIdList) throws Exception
    {
    ...
    @Given("^user enter actions details to Un-Reject products$")
    public void user_enter_actions_details_to_Un_Reject_products(List<BulkProductRequestModel> bulkProductRequestModelList) throws Exception
    {
    ...
    public void user_make_request_to_Un_Reject_products_in_bulk() throws Exception
    {
        jsonResponse= BulkUnRejectProductsBySellerService.BulkUnRejectProductsRequest(bulkProductRequestModel,LoginSteps.token);
    ...
    public void user_make_request_to_Un_Reject_products_in_bulk_with_invalid_Token(List<TokenMessageRequestModel> tokenMessageRequestModelList) throws Exception
    {
        jsonResponse= BulkUnRejectProductsBySellerService.BulkUnRejectProductsRequest(bulkProductRequestModel,tokenMessageRequestModelList.get(0).gettoken());

    }

    @Then("^user should be able to Un-Reject products in bulk$")
    public void user_should_be_able_to_Un_Reject_products_in_bulk() throws Exception
    {
    ...
    public void user_should_not_be_able_to_Un_Reject_products_in_bulk(List<String> errorMessage) throws Exception
    {
