  ...
  Scenario Outline: Login with valid registered user details as a Vendor and user wants to change password with existing password
    ...
    Scenario Outline: Login with valid registered user details as a Seller and user wants to change password with existing password
      When User is able to log into application
        | email                                 | password       |
    ...
    Scenario Outline: Login with valid registered user details as a Seller and without follow field validation user wants to change password with existing password
      When User is able to log into application
        | email                                 | password       |
        | vikrant.singh+100@successive.tech     | 123456789      |
      Then User should be able to login to the system and store token
    ...
    Scenario Outline: Login with valid registered user details as a Seller and without follow token field validation user wants to change password with existing password
      When User is able to log into application
        | email                                 | password       |
        | vikrant.singh+100@successive.tech     | 123456789      |
      Then User should be able to login to the system and store token
